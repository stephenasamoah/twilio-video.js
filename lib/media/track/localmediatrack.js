...
function mixinLocalMediaTrack(AudioOrVideoTrack) {
  ...
  return class LocalMediaTrack extends AudioOrVideoTrack {
    ...
    enable(enabled) {
      console.log('inside localmediatrack.enable:', enabled);
      enabled = typeof enabled === 'boolean' ? enabled : true;
      if (enabled !== this.mediaStreamTrack.enabled) {
        this._log.info(`${enabled ? 'En' : 'Dis'}abling`);
        console.log('setting this.mediaStreamTrack.enabled:', enabled);
        this.mediaStreamTrack.enabled = enabled;
        console.log('done setting this.mediaStreamTrack.enabled:', enabled);
        this.emit(enabled ? 'enabled' : 'disabled', this);
        console.log('done emitting after:', enabled);
      }
      console.log('done with localmediatrack.enable:', enabled);
      return this;
    }
