  ...
  _handleTrackSignalingEvents() {
    ...
    signaling.on('stateChanged', function stateChanged(state) {
      ...
      if (state === 'disconnected') {
        ...
        console.log('makarand: local participant disconnected');
        console.trace('makarand: local participant disconnected');
        log.info(`makarand: LocalParticipant disconnected. Stopping ${self._tracksToStop.size} automatically-acquired LocalTracks`);
